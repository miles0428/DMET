...
fragment_size = 2  # Each fragment will have 2 orbitals
...
DMET_instance = DMET(hubbard_problem,fragments=fragments,problem_solver=problemsolver,verbose=2,PBC=True)
